    ...
    return (
        <div className="flex flex-col w-full lg:w-1/2 bg-white rounded-xl p-4 xl:p-6 gap-4 shadow-md">
            <div className="flex justify-between items-center border-b border-gray-300 pb-4">
                <h2 className="text-sm xl:text-lg font-semibold">{translate("Personal Information")}</h2>
                <button className="text-sm text-primary">{translate("Edit profile")}</button>
            </div>
            ...
            <div className="flex justify-between items-center border-b border-gray-300 pb-4 mt-6">
                <h2 className="text-sm xl:text-lg font-semibold">{translate("Saved Address")}</h2>
                <button className="text-sm text-primary">+ {translate("Add new address")}</button>
            </div>
