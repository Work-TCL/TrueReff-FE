      ...
      <div className="bg-white rounded-xl col-span-2 flex flex-col gap-2">
        ...
        <div className="flex justify-center items-center border rounded-lg p-5">
          <div className="flex flex-col w-full gap-4">
            ...
            }}>{translate("Upload_your_photo")}</Button>
          </div>
        </div>
      </div>
      <div className="bg-white rounded-xl col-span-2 flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-center items-center border border-dashed rounded-lg p-5" onClick={()=> {
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <input type="file" id="banner_image" name="banner_image" className="hidden"/>
