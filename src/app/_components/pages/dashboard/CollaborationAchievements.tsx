...
// Sample Data
const products = [
    { brand: "Jane Doe", product: "Luxury Watch X", status: "Active", bid: "$500" },
                ...
                <Table className="min-w-full border border-gray-200 rounded-2xl">
                    <TableHeader className="bg-gray-100">
                        <TableRow>
                            ...
                            <CustomTableHead className="p-3 text-text text-left text-sm">{translate("Brand")}</CustomTableHead>
                            <CustomTableHead className="p-3 text-text text-left text-sm">{translate("Proposed_Bid")}</CustomTableHead>
                            <CustomTableHead className="p-3 text-text text-left text-sm">{translate("Status")}</CustomTableHead>
                    ...
                    <TableBody>
                        {products.map((activity, index) => (
                            <TableRow key={index} className="even:bg-gray-50">
                                ...
                                <CustomTableCell parentClassName="p-3 text-font-grey text-sm">{activity.brand}</CustomTableCell>
                                <CustomTableCell parentClassName="p-3 text-font-grey text-sm">{activity.bid}</CustomTableCell>
                                <CustomTableCell parentClassName="p-3 text-font-grey text-sm">{activity.status}</CustomTableCell>
