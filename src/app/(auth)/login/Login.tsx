            ...
            <div className="bg-white shadow sm:rounded-lg flex justify-center flex-1">
                <div className="flex-1 w-full text-center hidden lg:flex">
                    <div
                        ...
                        style={{ backgroundImage: "url('/assets/auth/login-image.svg')" }}
                    >
                    </div>
                </div>
                        ...
                        <div className="w-full flex-1 ">
                            ...
                            <div className="mx-auto max-w-lg mt-5">
                                ...
                                <div className="mt-6 text-[16px] flex align-middle justify-between  text-gray-600">
                                    <div><input type="checkbox" className="w-[20px] h-[20px]" />
                                    <span className="">Remember Me</span></div>
                                    <div className="cursor-pointer" onClick={()=> router.push("/forgot-password")}><span className="text-[#FF4979]">Forgot password?</span></div>
                                </div>
                                <button
                            ...
                            <div className="my-6 text-center">
                                <div
                                    className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">
                                    Don’t have an account?  <span className="text-[#FF4979]" onClick={() => {router.push("/register")}}>Sign up here</span>
                                </div>
                            </div>
                        </div>
                    </div>
