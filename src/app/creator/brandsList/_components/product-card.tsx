...
const ProductCard = ({
    ...
    return (
        <><Card key={product?.title} className="relative cursor-pointer w-full border border-stroke rounded-xl p-2 md:p-2 flex flex-col items-center text-center gap-3 hover:shadow-md transition-shadow bg-white overflow-hidden">
