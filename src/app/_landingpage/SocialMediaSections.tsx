    ...
    return (
        <section className="bg-gradient-to-br from-[#ffe2ec] to-[#e1f1ff] flex flex-col sm:gap-[18px] md:gap-32">
            <div className='flex flex-col justify-center'>
                ...
                <div className=" flex justify-center items-center mobile:ml-[170px] md:ml-[180px] sm:ml-[200px] lg:ml-[350px] h-[533px] pt-5 mobile:mt-[-110px]">
            ...
            <div className='flex flex-col justify-center items-center gap-5'>
                <p className=" mobile:text-2xl sm:text-4xl md:text-4xl lg:text-5xl font-medium text-gray-900 leading-6 pb-10">
                ...
                <div className='flex mobile:gap-3 sm:gap-4 mobile:h-[400px] sm:h-[400px] md:h-[551px]'>
                    <div className='rounded-tl-xl rounded-tr-xl h-full mobile:w-[130px] sm:w-[150px] md:w-[220px] lg:w-[250px] xl:w-[300px] flex flex-col text-center items-center justify-end  p-[40px] bg-[#38a2f5]'>
                    ...
                    <div className='rounded-tl-xl rounded-tr-xl sm:w-[200px]  mobile:w-[250pxpx] md:w-[300px] lg:w-[400px] xl:w-[600px] bg-primary flex flex-col items-center text-center justify-end'>
