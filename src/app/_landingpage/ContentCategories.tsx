...
export default function ContentCategories() {
    ...
    return (
        ...
        <div className='bg-[#f3ad1e] py-[85px]'>
            <div className="grid grid-cols-2 gap-[60px] items-center max-w-[1322px] mx-auto">
                    <div className='flex flex-col justify-center items-center gap-[10px]'>
                        <div className="flex gap-[10px]">
                            {categories.slice(0, 3).map((category, index) => (
                                <div key={index} className='h-[150px] w-[150px] flex items-center justify-center bg-[#FBBF12] rounded-[10px]'>
                        ...
                        <div className="flex gap-[10px]">
                            {categories.slice(3, 7).map((category, index) => (
                                <div key={index + 3} className='h-[150px] w-[150px] flex items-center justify-center bg-[#FBBF12] rounded-[10px]'>
                                    {category.cateGoriesIcon}
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex gap-[10px]">
                            {categories.slice(7, 10).map((category, index) => (
                                <div key={index + 7} className='h-[150px] w-[150px] flex items-center justify-center bg-[#FBBF12] rounded-[10px]'>
                                    {category.cateGoriesIcon}
                                </div>
                            ))}
                        </div>
                    ...
                    <div className=''>
                        <h2 className="text-7xl font-medium text-[#333333] max-w-[438px] mb-4 leading-[90px]">Are you one of <b>them?</b></h2>
