...
export default function UserOverView() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-3rem)] flex items-center justify-center overflow-hidden">
      {/* Moving Gradient Background */}
      <div className="moving-gradient-bg"></div>

      {/* Foreground content */}
      <div className="relative z-10 flex md:p-6 p-4 w-full flex-1 items-center justify-center">
