...
const TermsAndConditions = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-4">
        <strong>Applicable To:</strong> All registered brands using the Truereff
        platform.
      </p>
      <p className="mb-6">
        This Agreement outlines the terms and conditions under which brands
        engage in affiliate-based marketing campaigns with creators on Truereff.
        By listing products and launching campaigns on Truereff, brands agree to
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        <li>
          1.1 Brands may upload product details and initiate affiliate marketing
          campaigns on Truereff.
        </li>
        <li>
        ...
        <li>
          1.3 Brands can accept, reject, or counter commission bids submitted by
          creators.
        </li>
        <li>
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        ...
        <li>
          2.3 Truereff shall not be held responsible for any performance issues,
          missed sales, or creator concerns arising from insufficient wallet
          balance.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        <li>3.1 All creator commission payments are processed by Truereff.</li>
        <li>
          3.2 Commissions are deducted from the brand’s wallet based on verified
          sales tracked through the platform.
        </li>
        <li>
        ...
        <li>
          3.4 Truereff is not responsible for any tax or compliance obligations
          arising on the brand’s side in connection with the payouts.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        ...
        <li>
          4.2 Brands are not permitted to use creator-generated content for any
          purpose—including but not limited to marketing, ads, or
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        ...
        <li>
          5.3 The courts of Ahmedabad shall have exclusive jurisdiction over any
          unresolved disputes.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-6 space-y-1">
        <li>
          6.1 This Agreement applies to all brands using Truereff, regardless of
          individual contract signing.
        </li>
        <li>
          6.2 Truereff may amend this Agreement at any time, with notice
          provided via email or platform notification. Continued use of Truereff
          after such updates constitutes acceptance of the revised terms.
        </li>
        <li>
          6.3 By listing products or creating campaigns, the brand confirms its
          authority to represent its business and legally bind it to this
          Agreement.
        </li>
      </ul>
